...
const ItineraryDetails = () => {
    ...
    return (
        <div className="w-full min-h-screen flex flex-col items-center bg-purple-50 mt-12">
            ...
            <div className='p-4'>
                <h1 className='w-full text-indigo-800 text-center font-bold text-2xl md:text-4xl lg:text-5xl mt-8 p-4'>{itinerary?.name}</h1>
                ...
                <div className="mb-12">
                    <div className='w-full border rounded-2xl shadow bg-purple-50 shadow-indigo-400 mx-auto py-8 px-16 text-center font-semibold md:text-xl lg:text-2xl'>
                ...
                <div className='w-full'>
                    <div className='border rounded-2xl shadow shadow-indigo-400 mb-12 mx-auto py-8 px-16'>
                        <h3 className='w-full text-center font-semibold text-xl md:text-3xl lg:text-4xl mb-4'>Coments:</h3>
                    </div>
                </div>
            </div>
