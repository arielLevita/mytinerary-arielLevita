    ...
    return (
        <header className='img-cover relative w-full h-screen'>
            ...
            <div className='hero absolute w-full h-full flex flex-col justify-center items-center md:items-start p-8 text-white md:p-20'>
                ...
                <button className="bg-purple-700 shadow-sm font-semibold text-base md:text-xl text-white rounded-full hover:shadow-2xl hover:bg-purple-900 border-2 border-opacity-50 border-white pt-1.5 pb-2 px-3 my-4">Come check it!</button>
            </div>
        </header>
    )
}
